...
* To communicate to only a subset of your players, you have to be able
  to store and search players’ information to target your audience properly.
* To send advanced push notification related to complex events, for
  example a player’s friend has just beaten his high score on level 2, you
  need to implement and run computing intensive tasks.
