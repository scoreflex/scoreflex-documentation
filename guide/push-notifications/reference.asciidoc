...
security, you should always check if the provided target player id
...
This push notification is sent when it is the player turn to play in a
turn-based challenge.

Code: +102+.

Message: "It's your turn to playy!"
