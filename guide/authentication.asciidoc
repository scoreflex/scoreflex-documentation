...
http://developer.scoreflex.com/docs/reference/api/v1#post__v1_oauth_anonymousAccessToken[anonymousAccessToken reference].
...
We encourage you to define your own Facebook and Google+ applications for your mobile games and to enable native login. In this approach,
...
. Obtain an access token on Facebook or Google+ by authentication your player via your Facebook or Google+ application
...
http://developer.scoreflex.com/docs/reference/api/v1#post__v1_oauth_accessTokenExternallyAuthenticated[accessTokenExternallyAuthenticated reference].
